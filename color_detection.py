...
imageUrl = 'D:\SEM 6th\DWM Lab\Mini Project\Color-Detection-master\image01.jpg'
clicked = False
redValue = 0
greenValue = 0
blueValue = 0
...
colorNameDataFrame = pd.read_csv('D:\SEM 6th\DWM Lab\Mini Project\Color-Detection-master\wikipedia_color_names.csv')
